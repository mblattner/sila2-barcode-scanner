...
namespace BarcodeSila2Sever
{
    ...
    class is_SilaBaseImpl : is_sila.is_silaBase
    {
        ...
        public override Task<Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String> device_firmware_version(Org.SilaStandard.V2.RealeaseCandidate.Stdlib.Empty request, ServerCallContext context)
        {
            //throw new RpcException(nixGemacht, "JA aber Hallo");
            //Console.WriteLine("got Request: " + request.Id);
            //throw new Exception("Mist");            
            return Task.FromResult(new Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String { Data = firmware_version });
        }
        public override Task<Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String> device_manufacturer(Org.SilaStandard.V2.RealeaseCandidate.Stdlib.Empty request, ServerCallContext context)
        {
            return Task.FromResult(new Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String {Data = manufacturer });
        }
        public override Task<Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String> device_serial_number(Org.SilaStandard.V2.RealeaseCandidate.Stdlib.Empty request, ServerCallContext context)
        {
            return Task.FromResult(new Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String { Data = serial_number});
        }
        public override Task<Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String> service_name(Org.SilaStandard.V2.RealeaseCandidate.Stdlib.Empty request, ServerCallContext context)
        {
            return Task.FromResult(new Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String { Data = name });
        }
        public override Task<Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String> sila_interface_version(Org.SilaStandard.V2.RealeaseCandidate.Stdlib.Empty request, ServerCallContext context)
        {
            return Task.FromResult(new Org.SilaStandard.V2.RealeaseCandidate.Stdlib.String { Data = interface_version });
        }
    ...
    class canReadCodeImpl : can_ReadCode.can_ReadCodeBase
    {
        public override Task<ScannerResponse> read_Code(ScannerRequest request, ServerCallContext context)
        {
            System.String barcode;
            Console.WriteLine("got Request: " + request.Id);
            /*try
        ...
        public override Task<ScannerResponse> read_CodeWithException(Org.SilaStandard.V2.RealeaseCandidate.Stdlib.Empty request, ServerCallContext context)
        {
            System.String barcode;
            //Console.WriteLine("got Request: " + request.Id);
            try
    ...
    {
        public override Task<abortReply> abort(Org.SilaStandard.V2.RealeaseCandidate.Stdlib.Empty request, ServerCallContext context)
        {
            AbortScanning.abort = true;
        ...
        {   try
            {
                ...
                Server server = new Server
                {
                    ...
                    , can_ReadCode.BindService(new canReadCodeImpl())
